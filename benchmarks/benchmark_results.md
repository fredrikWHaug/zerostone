...
Zerostone v0.6.0 on synthetic multi-channel recordings with known ground truth.

Methodology follows SpikeInterface/SpikeForest: accuracy = TP / (TP + FN + FP), with 0.4 ms tolerance window and Hungarian matching.

## Results (seed=42, March 2026)

| Preset | Channels | Units | GT Spikes | Sorted | Accuracy | Precision | Recall | Time |
|--------|----------|-------|-----------|--------|----------|-----------|--------|------|
| easy   | 32       | 5     | 1476      | 1687   | **94.8%** | 99.1%    | 95.6%  | 2.3s |
| medium | 32       | 10    | 4865      | 3880   | **57.1%** | 81.9%    | 65.3%  | 4.4s |
| hard   | 64       | 20    | 11926     | 7939   | **25.1%** | 50.2%    | 33.4%  | 9.2s |
...
**Easy (5 units, 32 channels)**: All 5 units detected with >88% per-unit accuracy. High precision (99.1%) indicates very few false positives. The 4.4% missed recall comes from template alignment edge effects.

**Medium (10 units, 32 channels, noise_std=1.5)**: 3 of 10 units have template amplitude below the detection threshold (2.18, 2.47, 3.19 vs threshold 4.0). These 3 units account for ~30% of GT spikes and are fundamentally undetectable. The 7 detectable units average ~80% accuracy. Theoretical ceiling: ~67%.
